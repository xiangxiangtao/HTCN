...
class gas_real_7(imdb):
    def __init__(self, image_set, year, devkit_path=None):
        imdb.__init__(self, 'gas_real_7_' + year + '_' + image_set)
        self._year = year
        self._image_set = image_set
        self._devkit_path = cfg_d.GAS_REAL_7
    ...
    def _load_pascal_annotation(self, index):
        ...
        if self._image_set=='train':
            filename = "data/dataset/real/real_7_voc/Annotations/42_0.xml"#######################################for train:because train has no annotation,random read an annotation
        else:
            filename = os.path.join(self._data_path, 'Annotations', index + '.xml')
